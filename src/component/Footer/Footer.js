...
import { setFooterAction } from '../../redux/action/footer'

export default function Footer() {
    const dispatch = useDispatch()
    const logoArr = useSelector(state => state.footerReducer.logoArr)
    useEffect(() => {
        dispatch(setFooterAction())
    }, [])

    return (
        <footer className="py-6 bg-red-200 dark:text-gray-50">
            <div className="container px-6 mx-auto space-y-6 divide-y dark:divide-gray-400 md:space-y-12 divide-opacity-50">
                    ...
                    <div className="col-span-6 text-center md:text-left md:col-span-3">
                        ...
                        <ul className='flex '>
                            ...
                            {logoArr.map((item, index) => {
                                return <li key={index} className='mr-2'>
                ...
                <div className="grid justify-center pt-6 lg:justify-between">
                    ...
                    <div className="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
                        <a rel="noopener noreferrer" href="#" title="Email" className="flex items-center justify-center w-10 h-10 rounded-full dark:bg-red-600 dark:text-gray-900">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                                <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                                <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                            </svg>
                        </a>
                        <a rel="noopener noreferrer" href="#" title="Twitter" className="flex items-center justify-center w-10 h-10 rounded-full dark:bg-red-600 dark:text-gray-900">
                        ...
                        <a rel="noopener noreferrer" href="#" title="GitHub" className="flex items-center justify-center w-10 h-10 rounded-full dark:bg-red-600 dark:text-gray-900">
