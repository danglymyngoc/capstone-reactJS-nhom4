            ...
            <div className='container'>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 py-6'>
                    <div className='space-y-3'>
                        <h1 className="font-semibold text-lg">TIX</h1>
                        <ul className='grid grid-cols-1 md:grid-cols-1'>
                            <li className='cursor-pointer text-sm'>Thỏa thuận sử dụng</li>
                            <li className='cursor-pointer text-sm'>Chính sách bảo mật</li>
                        </ul>
                    </div>
                    <div className='space-y-3'>
                        <h1 className='font-semibold text-base'>ĐỐI TÁC</h1>
                    ...
                    <div className='space-y-3'>
                        <h1 className='font-semibold text-base'>MOBILE APPS</h1>
                        <ul className='grid grid-cols-4 gap-3'>
                    ...
                    <div className='space-y-3'>
                        <h1 className='font-semibold text-base'>SOCIAL</h1>
                        <ul className='grid grid-cols-4 gap-3'>
