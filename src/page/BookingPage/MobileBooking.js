        ...
        <div className='flex flex-col  items-center container-body text-center  mb-10 ' style={{
                ...
                <div className=' bg-current py-5'>
                    <div className='text-xs'>
                        {danhSachGhe?.map((item, index) => {
                            if (item.daDat === true) {
                                return <button className='gheDuocChon_M'><FontAwesomeIcon icon={faX} /></button>
                                ...
                                if (item.loaiGhe === 'Thuong') {
                                    ...
                                    }} className='ghe_M'>{item.tenGhe}</button>
                                } else {
                                    return <button onClick={() => {
                                        dispatch({
                                            type: DAT_GHE,
                                    ...
                                    }} className='gheVip_M'>{item.tenGhe}</button>
                                }
                            } else {
                                return <button onClick={() => {
                                    dispatch({
                                ...
                                }} className='gheDangChon_M'>{item.tenGhe}</button>

                            }
                        })}
                    </div>
                </div>
                <div className='flex justify-center shadow-lg bg-current pb-5 rounded-br rounded-bl text-xs'>
                    <div>
                        <span className='text-white' >Ghế đã đặt</span>
                        <button style={{ marginTop: 8 }} className='gheDuocChon_M font-semibold'><FontAwesomeIcon icon={faX} /></button>
                    </div>
                    <div>
                        <span className='text-white'>Ghế đang đặt</span>
                        <button className='gheDangChon_M'></button>
                    </div>
                    <div>
                        <span className='text-white'>Ghế thường</span>
                        <button className='ghe_M'></button>
                    </div>
                    <div>
                        <span className='text-white'>Ghế VIP</span>
                        <button className='gheVip_M'></button>
                    </div>
                </div>
            </div>
            <div className=' mt-5' style={{
                ...
                <div className='space-y-5'>
                    ...
                    <div className='flex items-center justify-between border-b py-1 text-sm'>
                        <h2 className='text-black '>Cụm Rạp:</h2>
                        <h2 className='text-red-600 '>{thongTinPhim.tenCumRap}</h2>
                    </div>

                    <div className='flex items-center justify-between border-b py-1'>
                        <h2 className='text-black  text-left w-20'>Địa chỉ:</h2>
                        <h2 className='text-red-600  text-right'>{thongTinPhim.diaChi}</h2>
                    </div>
                    <div className='flex items-center justify-between border-b py-1'>
                        <h2 className='text-black '>Rạp:</h2>
                        <h2 className='text-red-600 '>{thongTinPhim.tenRap}</h2>
                    </div>
                    <div className='flex items-center justify-between border-b py-1'>
                        <h2 className='text-black '>Ngày giờ chiếu:</h2>
                        <h2 className='text-red-600 '><span>{thongTinPhim.ngayChieu}</span> - <span>{thongTinPhim.gioChieu}</span></h2>
                    </div>
                    <div className='flex items-center justify-between border-b py-1'>
                        <h2 className='text-black '>Tên Phim:</h2>
                        <h2 className='text-red-600 '>{thongTinPhim.tenPhim} </h2>
                    </div>

                    <div className="flex flex-row my-5 justify-between border-b py-1">
                        <div >
                            <span className="text-black  mr-2">Ghế:</span>
